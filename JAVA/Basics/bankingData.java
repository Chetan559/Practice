...
public class bankingData {
    ...
    public static void main(String[] args) {
        ...
        accounts[3].setAccount(7129, "Chetan Sharma", 90000000);
        
        accounts[0] = new Account();
        accounts[0].setAccount(7137, "Sudhanshu Shekhar", 70000000);

        accounts[1] = new Account();
        accounts[1].setAccount(1304, "Vaibahv Bhavsar", 1000000);
        ...
        if (found) {
            System.out.println("The Account_id is found. "+ customer);
        } else {
